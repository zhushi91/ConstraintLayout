...
import com.geometry.constraintlayout.lib.CharterBar;
import com.geometry.constraintlayout.lib.CharterLine;
import com.geometry.constraintlayout.lib.CharterXLabels;
import com.geometry.constraintlayout.lib.CharterXMarkers;
import com.geometry.constraintlayout.lib.CharterYLabels;
import com.geometry.constraintlayout.lib.CharterYMarkers;
...
public class MainActivity extends AppCompatActivity {
    ...
    @Bind(R.id.charter_line_XMarker)
    ...
    @Bind(R.id.charter_line_YMarker)
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        charterLineWithLabel.setOnClickListener(new View.OnClickListener() {
            @Override public void onClick(View v) {
                values = fillRandomValues(50, DEFAULT_RANDOM_VALUE_MAX,
                        DEFAULT_RANDOM_VALUE_MIN);
                charterLineWithLabel.setValues(values);
